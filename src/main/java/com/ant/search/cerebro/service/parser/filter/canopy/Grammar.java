                ...
                while (address3 != FAILURE) {
                    ...
                    if (address4 != FAILURE) {
                        ...
                        if (chunk0 != null && chunk0.equals("OR")) {
                            address6 = new TreeNode(input.substring(offset, offset + 2), offset);
                            offset = offset + 2;
                        } else {
                            address6 = FAILURE;
                            if (offset > failure) {
                ...
                while (address3 != FAILURE) {
                    ...
                    if (address4 != FAILURE) {
                        ...
                        if (chunk0 != null && chunk0.equals("AND")) {
                            address6 = new TreeNode(input.substring(offset, offset + 3), offset);
                            offset = offset + 3;
                        } else {
                            address6 = FAILURE;
                            if (offset > failure) {
                            ...
                            if (address0 == FAILURE) {
                                    ...
                                    if (address52 != FAILURE) {
                                        ...
                                        if (address54 != FAILURE) {
                                            ...
                                            if (address55 != FAILURE) {
                                                ...
                                                String chunk11 = null;
                                                if (offset < inputSize) {
                                                    chunk11 = input.substring(offset, offset + 2);
                                                }
                                ...
                                if (address0 == FAILURE) {
                                        ...
                                        if (address62 != FAILURE) {
                                            ...
                                            if (address64 != FAILURE) {
                                                ...
                                                if (address65 != FAILURE) {
                                                    ...
                                                    String chunk13 = null;
                                                    if (offset < inputSize) {
                                                        chunk13 = input.substring(offset, offset + 1);
                                                    }
                                                        ...
                                                        if (address68 != FAILURE) {
                                                            ...
                                                            if (address70 != FAILURE) {
                                                                ...
                                                                if (address71 != FAILURE) {
                                                                    ...
                                                                    String chunk14 = null;
                                                                    if (offset < inputSize) {
                                                                        chunk14 = input.substring(offset, offset + 2);
                                                                    }
                                                                    ...
                                                                    if (address73 != FAILURE) {
                                                                        ...
                                                                        if (remaining22 <= 0) {
                                                                            address74 = new TreeNode(input.substring(index38, offset), index38, elements29);
                                                                            offset = offset;
                                                                        } else {
                                                                            address74 = FAILURE;
                                                                        }
                                    ...
                                    if (address0 == FAILURE) {
                                        ...
                                        String chunk15 = null;
                                        if (offset < inputSize) {
                                            chunk15 = input.substring(offset, offset + 3);
                                        }
                                        if (chunk15 != null && chunk15.equals("NOT")) {
                                        ...
                                        if (address77 == FAILURE) {
                                            address77 = new TreeNode(input.substring(index40, index40), index40);
                                            offset = index40;
                                        }
                                        if (address77 != FAILURE) {
                                            ...
                                            if (address78 != FAILURE) {
                                                ...
                                                if (address80 != FAILURE) {
                                                    ...
                                                    if (remaining24 <= 0) {
                                                        address81 = new TreeNode(input.substring(index42, offset), index42, elements32);
                                                        offset = offset;
                                                    } else {
                                                        address81 = FAILURE;
                                                    }
                                                    if (address81 != FAILURE) {
                                                        ...
                                                        String chunk16 = null;
                                                        if (offset < inputSize) {
                                                            chunk16 = input.substring(offset, offset + 1);
                                                        }
                                                        if (chunk16 != null && chunk16.equals(":")) {
                                                        ...
                                                        if (address83 != FAILURE) {
                                                            ...
                                                            if (remaining25 <= 0) {
                                                                address84 = new TreeNode(input.substring(index43, offset), index43, elements33);
                                                                offset = offset;
                                                            } else {
                                                                address84 = FAILURE;
                                                            }
                                        ...
                                        if (elements30 == null) {
                                            ...
                                            address0 = actions.make_string_token(input, index39, offset, elements30);
                                            offset = offset;
                                        }
                                        if (address0 == FAILURE) {
                                            offset = index1;
